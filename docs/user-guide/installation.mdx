...
**If you already have BepInEx installed, [skip this step](#installing-roguelibs).**

### Downloading BepInEx {#downloading-bepinex}

**[Go here](https://github.com/BepInEx/BepInEx/releases/latest) and download the version for your OS:**

<Tabs id="os" values="Windows,Linux,macOS">
...
<img src="/docs/img/installation/downloading-windows.png" />
...
<img src="/docs/img/installation/downloading-unix.png" />

</TabItem>
</Tabs>

:::caution{title="BepInEx v6"}
...
### Extracting files {#extracting-bepinex}

<Tabs
  id="vendor"
  values={[
    { value: "none", label: "I know where my game is installed!" },
    { value: "steam", label: "Steam", default: true },
    { value: "gog", label: "GOG" },
  ]}>
<TabItem value="steam">
...
<img src="/docs/img/installation/finding-the-game-1.png" width="300" />

Go to **Local files** and click **Browse...**:

<img src="/docs/img/installation/finding-the-game-2.png" width="600" />
...
<img src="/docs/img/installation/extract-bepinex.png" width="600" />
...
### Running the game {#running-bepinex}
...
## Installing RogueLibs {#installing-roguelibs}

<Tabs values={{ v3: "RogueLibs v3.x.x", v4: "RogueLibs v4.x.x" }}>
<TabItem value="v3">
...
<img src="/docs/img/installation/download-roguelibs.png" />

Go to the BepInEx's directory and put `RogueLibsCore.dll` file into `plugins` directory:

<img src="/docs/img/installation/drag-plugins.gif" width="600" />
...
<img src="/docs/img/installation/drag-patchers.gif" width="600" />

</TabItem>
<TabItem value="v4">

:::caution
RogueLibs v4.0.0 is still in beta, and while it may have some problems and bugs fixed, new ones may also be introduced.
:::
