...
namespace RogueLibsCore
{
    ...
    {
        /// <summary>
        ///   <para>Initializes a new instance of the <see cref="TraitBuilder"/> class with the specified <paramref name="metadata"/>.</para>
        /// </summary>
        /// <param name="metadata">The trait metadata to use.</param>
        public TraitBuilder(CustomTraitMetadata metadata) => Metadata = metadata;
        /// <summary>
        ///   <para>The used trait metadata.</para>
        /// </summary>
        public CustomTraitMetadata Metadata { get; }
        ...
        /// </summary>
        /// <returns>The current instance of <see cref="TraitBuilder"/>, for chaining purposes.</returns>
        public TraitBuilder WithUnlock() => WithUnlock(new TraitUnlock(Metadata.Name, true));
        /// <summary>
