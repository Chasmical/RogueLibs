...
namespace RogueLibsCore
{
	...
	public class CustomName : ICustomName, IEnumerable<KeyValuePair<LanguageCode, string>>
	{
		...
		/// <summary>
		///   <para>Internal translations dictionary.</para>
		/// </summary>
		...
		/// <summary>
		///   <para>Registers the specified <paramref name="language"/> with the specified <paramref name="code"/>.</para>
		/// </summary>
		/// <param name="language">Language string id, that is used by the game.</param>
		/// <param name="code"><see cref="LanguageCode"/> associated with the specified <paramref name="language"/> id.</param>
