...
<FAQ>
<Question>I also have ECTD (Edit Characters Through Description) mod installed.</Question>

Sorry, but at the moment, RogueLibs v3 is not compatible with ECTD.  
I'm working on that and will fix the issue in one of the updates.
