...
:::tip Pro-tip
You can see for yourself how these methods are implemented in [RogueLibs' source code](https://github.com/Abbysssal/RogueLibs/blob/master/RogueLibsCore/Hooks/Unlocks/UnlockWrapper.cs).
:::
