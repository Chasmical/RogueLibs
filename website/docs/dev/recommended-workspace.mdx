...
```bash
"..\..\.events\PluginBuildEvents.exe" "$(TargetPath)" "Streets of Rogue"
```
...
```bash
"..\..\.events\PluginBuildEvents.exe" "$(TargetPath)" "C:\GOG Games\Streets of Rogue"
```
:::
...
```bash
"..\..\.events\PluginBuildEvents.exe" --launch 512900
```
