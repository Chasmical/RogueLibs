...
**[SoR ModHub](https://sugarbarrel.github.io/SoRModHub)** - это коллекция модов, использующих последнюю версию RogueLibs v3, о которых я знаю. Содержит ссылки на другие источники и регулярно обновляется.
