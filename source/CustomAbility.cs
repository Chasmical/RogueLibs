...
namespace RogueLibsCore
{
	...
	public class CustomAbility
	{
		...
		/// </summary>
		public Func<Agent, PlayfieldObject> FindObject { get; set; }
		/// <summary>
		...
		/// </summary>
		public Action<Agent, PlayfieldObject> InterfaceCheck { get; set; }
		/// <summary>
		...
		///   <para><see cref="Agent"/> arg1 is the special ability's owner;<br/><see cref="PlayfieldObject"/> arg2 is the target object that was found using <see cref="FindObject"/> delegate.</para>
		/// </summary>
		public Action<Agent, PlayfieldObject> OnPressed { get; set; }
		/// <summary>
		...
		///   <para><see cref="Agent"/> arg1 is the special ability's owner;<br/><see cref="PlayfieldObject"/> arg2 is the target object that was found using <see cref="FindObject"/> delegate.</para>
		/// </summary>
		public Action<Agent, PlayfieldObject> OnHeld { get; set; }
		/// <summary>
		...
		///   <para><see cref="Agent"/> arg1 is the special ability's owner;<br/><see cref="PlayfieldObject"/> arg2 is the target object that was found using <see cref="FindObject"/> delegate.</para>
		/// </summary>
		public Action<Agent, PlayfieldObject> OnReleased { get; set; }
